      ...
      module Commands
        module ArtifactTypeValidate
          ...
          def run(argv:, stdout:, stderr:, cwd:, env: ENV.to_h) # rubocop:disable Lint/UnusedMethodArgument
            ...
            result = Owl::Artifacts::Api.validate(root: root, id_or_path: target)
            if result.err?
          ...
          def parse_options(argv)
            ...
            parser = OptionParser.new do |opts|
              opts.banner = 'Usage: owl artifact-type validate ID-OR-PATH [--root PATH] [--json]'
