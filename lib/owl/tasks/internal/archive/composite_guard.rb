    ...
    module Internal
      module Archive
        module CompositeGuard
          ...
          def call(task_payload:, index_path:, tasks_root:)
            ...
            return Result.ok(checked: true, ready_children: []) if open_children_ids.empty?
          ...
          def subtree_check(task_id:, open_children_ids:, tasks_root:)
            ...
            return Result.ok(checked: true, ready_children: open_children_ids) if unready.empty?
